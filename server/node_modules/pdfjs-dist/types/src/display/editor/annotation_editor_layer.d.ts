export type AnnotationEditorUIManager = import("pdfjs-dist/types/src/display/editor/tools.js").AnnotationEditorUIManager;
export type PageViewport = import("pdfjs-dist/types/src/display/display_utils.js").PageViewport;
export type TextAccessibilityManager = import("pdfjs-dist/types/web/text_accessibility.js").TextAccessibilityManager;
export type IL10n = import("pdfjs-dist/types/web/interfaces.js").IL10n;
export type AnnotationLayer = import("pdfjs-dist/types/src/display/annotation_layer.js").AnnotationLayer;
export type DrawLayer = import("pdfjs-dist/types/src/display/draw_layer.js").DrawLayer;
...
export type AnnotationEditorLayerOptions = {
    ...
    enabled: boolean;
    accessibilityManager?: import("pdfjs-dist/types/web/text_accessibility.js").TextAccessibilityManager | undefined;
    pageIndex: number;
    l10n: IL10n;
    annotationLayer?: import("pdfjs-dist/types/src/display/annotation_layer.js").AnnotationLayer | undefined;
...
export class AnnotationEditorLayer {
    ...
    pageIndex: number;
    div: HTMLDivElement;
    viewport: import("pdfjs-dist/types/src/display/display_utils.js").PageViewport;
    drawLayer: import("pdfjs-dist/types/src/display/draw_layer.js").DrawLayer;
    _structTree: any;
    get isEmpty(): boolean;
...
import { AnnotationEditor } from "pdfjs-dist/types/src/display/editor/editor.js";
import { FreeTextEditor } from "pdfjs-dist/types/src/display/editor/freetext.js";
import { HighlightEditor } from "pdfjs-dist/types/src/display/editor/highlight.js";
import { InkEditor } from "pdfjs-dist/types/src/display/editor/ink.js";
import { SignatureEditor } from "pdfjs-dist/types/src/display/editor/signature.js";
import { StampEditor } from "pdfjs-dist/types/src/display/editor/stamp.js";
